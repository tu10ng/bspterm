        ...
        let edit_debug_json_button = || {
            IconButton::new("debug-edit-debug-json", IconName::Code)
                ...
                .on_click(|_, window, cx| {
                    window.dispatch_action(bspterm_actions::OpenProjectDebugTasks.boxed_clone(), cx);
                })
                ...
                if let Some(active_session) = self.active_session.clone() {
                    ...
                    let welcome_experience = v_flex()
                            ...
                            Button::new("edit-debug-settings", "Edit debug.json")
                                ...
                                .on_click(|_, window, cx| {
                                    window.dispatch_action(
                                        bspterm_actions::OpenProjectDebugTasks.boxed_clone(),
                                        cx,
                                    );
                                }),
                        )
                        ...
                        .child(
                            ...
                            .on_click(|_, window, cx| {
                                window.dispatch_action(
                                    bspterm_actions::Extensions {
                                        category_filter: Some(
                                            bspterm_actions::ExtensionCategoryFilter::DebugAdapters,
                                        ),
                                        id: None,
                                    }
                                    .boxed_clone(),
