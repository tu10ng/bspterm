...
use bspterm_actions::{outline::ToggleOutline, workspace::CopyPath, workspace::CopyRelativePath};
...
pub use bspterm_actions::buffer_search::{Deploy, DeployReplace, Dismiss, FocusEditor};
